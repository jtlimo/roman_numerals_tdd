...
describe RomanNumerals do
  describe '#return_arabic_numeral' do
    context 'simple roman numeral conversion to arabic numeral' do
      it 'convert roman numerals to arabic numerals' do
        ...
        arabic_number = roman_numerals.return_arabic_numeral
...
describe RomanNumerals do
  describe '#return_arabic_numeral' do
    context 'rules of roman numerals' do
      it 'symbols not repeated for more than three times', focus: true do
...
describe RomanNumerals do
  describe '#return_arabic_numeral' do
    context 'rules of roman numerals' do
      it 'symbols is subtracted if had a greather value after sequency' do
        roman_numerals = RomanNumerals.new('XXXIX')
        arabic_number = roman_numerals.return_arabic_numeral
        expect(arabic_number).to eq 39
      end
    end
  end
end
